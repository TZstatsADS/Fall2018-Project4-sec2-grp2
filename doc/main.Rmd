...
correct_path <- "C:/Users/SHE3/Desktop/Fall2018-Project4-sec2--sec2proj4_grp2/output/correct/"
...
## read ground truth text
 current_ground_truth_txt <- readLines(paste0(dir_names[i]), warn=FALSE,encoding = "UTF-8")
    ground_truth_vec <- str_split(paste(current_ground_truth_txt, collapse = " ")," ")[[1]]
ground_truth_vec <- str_split(paste(current_ground_truth_txt, collapse = " ")," ")[[1]]
...
```{r}
noerror_path <- "C:/Users/SHE3/Desktop/Fall2018-Project4-sec2--sec2proj4_grp2/output/delete_error/"
...
```{r}
measurement_correct(tesseract_dir=t_dir_names,result_dir=correct_dir_names,truth_dir=dir_names)
```
