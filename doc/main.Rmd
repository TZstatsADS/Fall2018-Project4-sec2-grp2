...
intersect_vec_unique <- vecsets::vintersect(tolower(ground_truth_vec), tolower(tesseract_vec))
intersect_vec_unique <- unique(intersect_vec_unique) %>% removePunctuation() %>% removeNumbers()
intersect_vec_unique <- intersect_vec_unique[intersect_vec_unique!=""]
```
...
2. Kukich, K. (1992). *Techniques for automatically correcting words in text*. Acm Computing Surveys (CSUR), 24(4), 377-439. [pdf](http://www.unige.ch/eti/ptt/docs/kukich-92.pdf)
>>>>>>> 1bba623b390472913f16ce9201db7cb61e7b2cc6
